...
namespace Microsoft.Legal.MatterCenter.Web.Controllers
{
    ...
    public class ConfigController : Controller
    {
        ...
        public async Task<IActionResult> Get([FromBody] ConfigEntities configRequest)
        {
            ...
            try
            {
                ...
                return matterCenterServiceFunctions.ServiceResponse(configResultsVM.ConfigEntries, (int)HttpStatusCode.OK);
            }
